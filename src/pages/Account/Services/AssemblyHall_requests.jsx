...
const AssemblyHallRequests = () => {
    ...
    const [reservations, setReservations] = useState([
        { id: 1, user: 'John Doe', event: 'Conference', description: 'Annual Tech Conference', hall: 'Hall A', capacity: 200, date: '2025-01-25', payment: 'Paid', paymentAmount: 10000, status: 'Confirmed' },
        { id: 2, user: 'Jane Smith', event: 'Seminar', description: 'Leadership Seminar', hall: 'Hall B', capacity: 150, date: '2025-01-26', payment: 'Unpaid', paymentAmount: 5000, status: 'Pending' },
        { id: 3, user: 'David Brown', event: 'Workshop', description: 'AI Workshop', hall: 'Hall C', capacity: 100, date: '2025-01-27', payment: 'Paid', paymentAmount: 7000, status: 'Rejected' },
        { id: 4, user: 'Steve Harrington', event: 'Meeting', description: 'Board Meeting', hall: 'Hall A', capacity: 200, date: '2025-01-23', payment: 'Paid', paymentAmount: 8000, status: 'Cancelled', note: 'Double booking' },
        { id: 5, user: 'Paloma Diamond', event: 'Fashion Show', description: 'Spring Collection Launch', hall: 'Hall B', capacity: 150, date: '2025-01-22', payment: 'Paid', paymentAmount: 12000, status: 'Cancelled', note: 'Insufficient space' },
    ]);
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-gray-100">
                                ...
                                <th className="px-6 py-3 border-b border-gray-200 text-sm font-medium text-gray-700">Capacity</th>
                        ...
                        <tbody>
                            {filteredReservations.map((reservation) => (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4 border-b border-gray-200 text-sm text-gray-700">{reservation.capacity}</td>
