...
const Playground_past = () => {
    ...
    const [reservations, setReservations] = useState([
        { id: 1, user: 'John Doe', event: 'Football Match', description: 'Quarter-finals', ground: 'Ground 1', date: '2024-01-25', payment: 'Paid', paymentAmount: 5000, status: 'Booked' },
        { id: 2, user: 'Jane Smith', event: 'Cricket Match', description: 'Semi-finals', ground: 'Ground 2', date: '2024-01-26', payment: 'Paid', paymentAmount: 3000, status: 'Booked' },
