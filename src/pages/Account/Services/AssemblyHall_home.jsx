        ...
        <div className="space-y-4">
          ...
          <div className="bg-white shadow-md rounded-lg p-4">
            <div className="flex justify-between items-center mb-2">
              <h3 className="text-lg font-semibold text-blue-700">Assembly Hall Management</h3>
              <Link to="/AssemblyHall_home/ManageAssemblyHallAcc">
            ...
            <Accordion allowToggle onChange={() => handleAccordionToggle(0)}>
              <AccordionItem>
                ...
                <AccordionPanel pb={4} className="text-gray-700 text-base">
                  Here you can manage details about your assembly halls, including adding, updating, or deleting them.
                </AccordionPanel>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <Link to="/AssemblyHall_home/HallRequestsAcc">
                <Button variant="outline" colorScheme="teal" size="sm" className="mb-2">
                  Review Requests
                </Button>
              </Link>
          ...
          <div className="bg-white shadow-md rounded-lg p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <Link to="/AssemblyHall_home/HallHistoryAcc">
                <Button variant="outline" colorScheme="teal" size="sm" className="mb-2">
                  View History
                </Button>
              </Link>
...
export default AssemblyHall_home;