...
const AssemblyHallPast = () => {
    ...
    const [reservations, setReservations] = useState([
        { id: 1, user: 'John Doe', event: 'Conference', description: 'Annual Tech Conference', hall: 'Hall A', capacity: 200, date: '2024-01-25', payment: 'Paid', paymentAmount: 10000, status: 'Completed' },
        { id: 2, user: 'Jane Smith', event: 'Seminar', description: 'Leadership Seminar', hall: 'Hall B', capacity: 150, date: '2024-01-26', payment: 'Paid', paymentAmount: 5000, status: 'Completed' },
        ...
        { id: 4, user: 'Alice Johnson', event: 'Meeting', description: 'Board Meeting', hall: 'Hall A', capacity: 200, date: '2024-02-10', payment: 'Unpaid', paymentAmount: 8000, status: 'Rejected' },
        { id: 5, user: 'Bob Williams', event: 'Fashion Show', description: 'Spring Collection Launch', hall: 'Hall B', capacity: 150, date: '2024-02-15', payment: 'Paid', paymentAmount: 12000, status: 'Rejected' },
    ]);
