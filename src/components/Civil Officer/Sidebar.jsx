...
const Menus = [
    { title: 'Home', icon:<RiDashboardFill />  },
    { title: 'Calendar Schedule', icon:<RiCalendar2Line /> },
    { title: 'Appointments', icon:<RiFileList2Line /> },
    { title: 'Service Requests', icon:<RiServiceLine /> },
    { title: 'Analytics',icon:<RiBarChart2Fill /> },
